...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'display-1': ['4.5rem', { lineHeight: '1.1', letterSpacing: '-0.03em', fontWeight: '600' }],
        'display-2': ['3.75rem', { lineHeight: '1.15', letterSpacing: '-0.025em', fontWeight: '600' }],
        'display-3': ['3rem', { lineHeight: '1.2', letterSpacing: '-0.02em', fontWeight: '600' }],
        'headline': ['1.75rem', { lineHeight: '1.3', letterSpacing: '-0.01em', fontWeight: '600' }],
        'subheadline': ['1.25rem', { lineHeight: '1.5', fontWeight: '500' }],
